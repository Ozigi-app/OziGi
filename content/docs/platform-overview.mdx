...
**Qualifying.** Every sourced lead is scored 0.0 to 1.0 against your ICP. Anything under 0.3 is discarded as it is sourced, and the rest are worked in score order — which keeps your sending list clean without manual filtering.
