...
The practical upshot is that you can build a developer lead list from public signal alone, no purchased database required. The mechanics of doing that, including the exact GitHub search qualifiers and how to recover a contact email, are covered in the companion piece on [how to find B2B leads on GitHub and Dev.to](https://ozigi.app/blog/how-to-find-b2b-leads-github-devto).
...
This is why a small team should treat the ICP as a living thing, not a document written once and filed away. Your first version is a hypothesis. Your reply data is the test. Revisit it every few weeks against the [weekly go-to-market loop](https://ozigi.app/blog/go-to-market-playbook-solo-founder-technical-team), and let real responses pull the profile into focus.
...
*Want to define an ICP once and have it source and score leads automatically? [Ozigi](https://ozigi.app) turns a developer profile into a qualified lead list and writes the outreach in your voice. Free to start, no credit card. Try the [free cold email generator](https://ozigi.app/email-outreach) to see a sample message for your ICP.*
