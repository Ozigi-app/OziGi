...
**CRM sync**
Leads push to HubSpot or Zoho on first contact via a Composio connection. The sync is one-way write-on-first-contact; the CRM remains the source of truth for the pipeline.
