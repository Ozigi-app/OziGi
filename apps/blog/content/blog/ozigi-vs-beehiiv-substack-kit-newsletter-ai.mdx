...
Yes, on GitHub at Ozigi-app/OziGi. The validator architecture, persona system, and email delivery layer are all documented on the [Ozigi blog](https://ozigi.app/blog).
