...
2. **Generate the longform draft in [Ozigi's free long-form generator](https://ozigi.app/long-form)** using the technical brief format. Drop in the GitHub URL and the architecture notes. The persona shapes the output as engineering writing, not marketing copy. The banned lexicon strips out "robust," "leverage," and "seamless."
