...
The fix is a tighter target. A specific message to 50 well-chosen people beats a generic one to 500 strangers, every time. If your reply rate is near zero across a big list, the list is the most likely problem. Tightening your [ideal customer profile](https://ozigi.app/blog/ideal-customer-profile-for-developer-products) and sourcing only people who match it is usually the single biggest lever you have.
