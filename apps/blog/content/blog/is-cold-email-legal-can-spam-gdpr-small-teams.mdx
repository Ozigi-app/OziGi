...
*This article is general information, not legal advice. Confirm the rules for your jurisdiction and situation with a qualified attorney. [Ozigi](https://ozigi.app) builds compliant defaults into outreach, one-click unsubscribe, opt-out tracking, and sending from your own accounts, so the basics are handled while the responsibility stays yours. Free to start.*
